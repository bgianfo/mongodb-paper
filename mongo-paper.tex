...
database system. The database has no schema and claims it specializes in 
high performance, through clustering/sharding and a focus on concurrent algorithms.
MongoDB has a variaty of very unique features which set it aside from other "NoSQL" systems.
